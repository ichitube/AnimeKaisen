...
from app.data import character_photo, mongodb
from app.routers.tokio import tokio, dungeon, store, Pay, home, quests, clans, boss
...
UPDATES_TOTAL = Counter("bot_updates_total", "Total updates processed")
